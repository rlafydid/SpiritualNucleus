...
half4 CustomUniversalFragmentBlinnPhong(InputData inputData, half3 diffuse, half4 specularGloss, half smoothness, half3 emission, half alpha)
{
    ...
    #endif
    diffuse *= lerp(_ShadowColor.rgb, half3(1, 1, 1), mainLight.shadowAttenuation); // 2022年6月21日  场景需要在BaseColor里面加入阴影和阴影颜色
...
Varyings LitPassVertexSimple(Attributes input)
{
    ...
    output.uv = output.uv + float2(_UVSpeed, 0) * (_Time.y); //新增UV运动  frac(_Time.y); 
