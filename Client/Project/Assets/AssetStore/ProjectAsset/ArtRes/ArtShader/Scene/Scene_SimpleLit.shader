...
Shader "ORII/Scene/SimpleLit/Scene_Simple Lit"
{
    ...
    Properties
    {
        ...
        _UVSpeed("MainTex UVSpeed", Float) = 0.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // #pragma shader_feature_local_vertex _UVSPEED_ON
            ...
            #include "../ShaderLibrary/SceneSimpleLitInput.hlsl"
            #include "../ShaderLibrary/SceneSimpleLitForwardPass.hlsl"
            ENDHLSL
        }
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.SceneSimpleLitShader"
}