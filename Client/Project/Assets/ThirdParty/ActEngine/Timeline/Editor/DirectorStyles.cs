...
namespace UnityEditor.ActTimeline
{
    class DirectorStyles
    {
        ...
        const string k_ImagePath = "Assets/ThirdParty/ActEngine/Timeline/Editor/StyleSheets/Images/Icons/{0}.png";
        public const string resourcesPath = "Assets/ThirdParty/ActEngine/Timeline/Editor/StyleSheets/res/";
        ...
        public static readonly GUIContent noAssetsInModel = TrTextContent("No actAsset found in the model");
