    ...
    class ItemsGroup
    {
        ...
        public double start
        {
            ...
            set
            {
                ...
                {
                    clip.start += offset;
                    if (clip.gui.clip.GetClipType == UnityEngine.ActTimeline.ClipType.Event)
                    {
                        clip.start = UnityEngine.ActTimeline.TimeUtility.RoundToFrame(clip.start, Act.ActUtility.EventFPS);
                    }
                }
            }
        }
