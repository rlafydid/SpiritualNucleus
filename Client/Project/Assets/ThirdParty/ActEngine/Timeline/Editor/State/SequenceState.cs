    ...
    class SequenceState : ISequenceState
    {
        ...
        public double time
        {
            ...
            set
            {
                ...
                var correctedValue = Math.Min(value, m_WindowState.maxTime);
                ...
                TimelineWindow.instance.Simulate();
            }
        }
        ...
        public SequenceState(WindowState windowState, Act.ActAsset asset, SequenceState parentSequence)
        {
            m_WindowState = windowState;
            m_ParentSequence = parentSequence;
