...
namespace UnityEditor.ActTimeline
{
    ...
    class WindowState : IWindowState
    {
        ...
        public TimelineAsset.DurationMode GetDurationMode
        {
            get
            {
                //return editSequence.asset.durationMode; //待处理1
        ...
        public bool previewMode
        {
            ...
            {
                _previewMode = value;
                Act.ActTimelineDebugger.previewMode = value;
            }
        }
        ...
        public void SetCurrentSequence(Act.ActAsset asset)
        {
            if (OnBeforeSequenceChange != null)
                OnBeforeSequenceChange.Invoke();
        ...
        public Vector2 timeAreaShownRange
        {
            get
            {
                if (m_Window.state.IsReadyAsset)
        ...
        public void Play()
        {
            ...
            previewMode = true;
            Act.ActTimelineDebugger.Play();
            isPlaying = true;
        }

        public void Pause()
        {
            Act.ActTimelineDebugger.Pause();
            isPlaying = false;
