...
namespace UnityEditor.ActTimeline
{
    ...
    public static class TimelineEditor
    {
        ...
        /// <see cref="UnityEngine.ActTimeline.TimelineAsset"/>, based on the <see cref="RefreshReason"/> provided.
        /// </para>
        /// <para>
        /// For better performance, it is recommended that you invoke this method once, after you modify the
        /// <see cref="UnityEngine.ActTimeline.TimelineAsset"/>. You should also combine reasons using the <c>|</c> operator.
        /// </para>
        /// </summary>
        /// <remarks>
