...
namespace UnityEditor.ActTimeline
{
    static class ItemToItemGui
    {
        ...
        public static TimelineItemGUI GetGuiForClip(TimelineClip clip)
        {
            return GetGuiForItem(clip);
        }
    ...
    abstract class TimelineItemGUI : ISelectable
    {
        ...
        protected TimelineClip _clip;
        public TimelineClip clip
        {
            get { return _clip; }
        }

        protected TimelineItemGUI()
        {
