...
namespace UnityEditor.ActTimeline
{
    ...
    partial class TimelineTreeView : ITreeViewGUI
    {
        ...
        {
            Debug.Log("ItemDoubleClickedCallback");
        ...
        {
            Debug.Log("ContextClickOutsideItemsCallback");
        ...
        void ContextClickItemCallback(int id)
        {
            ...
            {
                NewContextClickItemCallback(id);
                return;
            }
            Debug.Log("ContextClickItemCallback");
        ...
        void SelectionChangedCallback(int[] ids)
        {
            if (TimelineSwitch.isUseNew)
            {
                NewSelectionChangedCallback(ids);
                return;
            }
            Debug.Log("SelectionChangedCallback");
        ...
        {
            NewOnRowGUI(rowRect, item, row, selected, focused);
        }
