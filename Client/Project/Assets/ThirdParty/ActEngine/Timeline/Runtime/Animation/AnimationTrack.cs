...
namespace UnityEngine.ActTimeline
{
    ...
    public partial class AnimationTrack : TrackAsset, ILayerable
    {
...
#if UNITY_EDITOR
        private static string k_DefaultHumanoidClipPath = "Assets/ThirdParty/ActEngine/Timeline/Editor/StyleSheets/res/HumanoidDefault.anim";
        ...
        private Transform GetGenericRootNode(GameObject gameObject)
        {
            ...
            return FindInHierarchyBreadthFirst(animator.transform, null);
        }
