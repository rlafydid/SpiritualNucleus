...
namespace UnityEngine.ActTimeline
{
    public partial class TimelineAsset
    {
        ...
        public enum MediaType
        {
            ...
            /// <see cref="UnityEngine.ActTimeline.TimelineAsset.MediaType"/> is obsolete.
            /// </summary>
            Animation,
            ...
            /// <see cref="UnityEngine.ActTimeline.TimelineAsset.MediaType"/> is obsolete.
            /// </summary>
            [Obsolete("Use Texture MediaType instead. (UnityUpgradable) -> UnityEngine.ActTimeline.TimelineAsset/MediaType.Texture", false)]
            Video = 2,
    ...
    public class TrackMediaType : Attribute // Defines the type of a track
    {
        ...
        /// <see cref="UnityEngine.ActTimeline.TrackMediaType"/> is obsolete; it will have no effect.
        /// </summary>
